...
def OP1():
    os.system('Medicine_list.py')

def OP2():
    os.system('Post_Medicine1.py')


main = Tk()
main.state('zoomed')
main.title("Welcome to Medicine Orders")
...
Button(frame, text='View Order List', font='40', width=25,command=OP1,bg='dark blue',fg='white').pack()

frame2 = LabelFrame(main, bd=5 , bg="light blue",width=0,padx=0,pady=2)
frame2.pack(expand="yes")
                
Button(frame2, text='View Full Order', font='40', width=25,command=OP2,bg='darkblue',fg='white').pack()
